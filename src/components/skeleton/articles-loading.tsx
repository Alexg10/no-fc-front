export function ArticlesLoading() {
  return (
    <div className="space-y-8">
      <div>
        <div className="h-10 w-40 bg-zinc-200 dark:bg-zinc-800 rounded animate-pulse mb-2" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {Array.from({ length: 6 }).map((_, i) => (
          ...
          >
            <div className="w-full aspect-video bg-zinc-200 dark:bg-zinc-800 animate-pulse" />
