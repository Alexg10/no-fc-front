      ...
      <Grid>
        <div className="col-span-full">
          {title && (
            <BlockRendererClient
              content={title}
              className="heading-m-obviously! [&>*>br]:hidden [&>p]:heading-m-obviously! [&>h2]:heading-m-obviously!  [&>h3]:heading-m-obviously! [&>h4]:heading-m-obviously! [&>h5]:heading-m-obviously! [&>h6]:heading-m-obviously! text-center"
            />
          )}
        </div>
